...
func draw_fixed(fixed_drawing):
	for i in range(fixed_drawing_array.size()):
		fixed_drawing_array[i].modulate = fixed_drawing
...
func _on_lightgray_button_down():
	selected_color = Color.LIGHT_GRAY

func _on_gray_button_down():
	selected_color = Color.DIM_GRAY
...
func _on_green_button_down():
	selected_color = Color.WEB_GREEN

func _on_cyan_button_down():
	selected_color = Color.DARK_CYAN

func _on_lightblue_button_down():
	selected_color = Color.DEEP_SKY_BLUE

func _on_blue_button_down():
	selected_color = Color.MEDIUM_BLUE

func _on_purple_button_down():
	selected_color = Color.PURPLE

func _on_pink_button_down():
	selected_color = Color.HOT_PINK

func _on_brown_button_down():
	selected_color = Color.SADDLE_BROWN
